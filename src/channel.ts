...
namespace sdt {
   ...
   export var channel = {
      emit: function (name, value) { console.error('//TODO'); },
      on: function (name, callback) { console.error('//TODO'); },
      off: function (name, callback) { console.error('//TODO'); }
   }
   if (!sdt.platform.isRunningInNodejs) {
      channel = function (entry: any) {
         var listeners = {};

         if (/MSIE 8/.test(navigator.userAgent)) {
            (window as any).attachEvent('storage', function () {
               // TODO: ie8 support
            });
         } else {
